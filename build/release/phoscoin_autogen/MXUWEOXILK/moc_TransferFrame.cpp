...
QT_MOC_LITERAL(1, 25, 19), // "commentEditedSignal"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 18), // "addressBookClicked"
QT_MOC_LITERAL(4, 65, 13), // "addressEdited"
QT_MOC_LITERAL(5, 79, 5), // "_text"
QT_MOC_LITERAL(6, 85, 13), // "commentEdited"
QT_MOC_LITERAL(7, 99, 12) // "pasteClicked"

    },
    "WalletGui::TransferFrame\0commentEditedSignal\0"
    "\0addressBookClicked\0addressEdited\0"
    "_text\0commentEdited\0pasteClicked"
};
...
void WalletGui::TransferFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->commentEditedSignal(); break;
        case 1: _t->addressBookClicked(); break;
        case 2: _t->addressEdited((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->commentEdited((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 4: _t->pasteClicked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TransferFrame::commentEditedSignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void WalletGui::TransferFrame::commentEditedSignal()
{
