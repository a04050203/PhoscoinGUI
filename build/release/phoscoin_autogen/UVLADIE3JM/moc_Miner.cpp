...
QT_MOC_LITERAL(1, 17, 17), // "socketErrorSignal"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 10) // "_errorText"

    },
    "WalletGui::Miner\0socketErrorSignal\0\0"
    "_errorText"
};
...
void WalletGui::Miner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->socketErrorSignal((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Miner::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::socketErrorSignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void WalletGui::Miner::socketErrorSignal(const QString & _t1)
{
