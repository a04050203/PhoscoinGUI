...
public:
    ...
    {
        DepositDetailsDialog->setWindowTitle(QApplication::translate("DepositDetailsDialog", "Deposit", 0));
        m_closeButton->setText(QApplication::translate("DepositDetailsDialog", "Close", 0));
    } // retranslateUi
