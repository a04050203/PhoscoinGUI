...
public:
    ...
    {
        ImportKeyDialog->setWindowTitle(QApplication::translate("ImportKeyDialog", "Import private key", 0));
        label->setText(QApplication::translate("ImportKeyDialog", "Key:", 0));
        label_2->setText(QApplication::translate("ImportKeyDialog", "Wallet path:", 0));
        m_selectPathButton->setText(QApplication::translate("ImportKeyDialog", "...", 0));
        m_cancelButton->setText(QApplication::translate("ImportKeyDialog", "Cancel", 0));
        m_okButton->setText(QApplication::translate("ImportKeyDialog", "OK", 0));
    } // retranslateUi
