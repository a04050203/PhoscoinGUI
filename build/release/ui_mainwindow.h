...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        m_exchange = new QAction(MainWindow);
        m_exchange->setObjectName(QStringLiteral("m_exchange"));
        m_Block_Explorer = new QAction(MainWindow);
        m_Block_Explorer->setObjectName(QStringLiteral("m_Block_Explorer"));
        ...
        m_messagesFrame->setObjectName(QStringLiteral("m_messagesFrame"));
        ...
        m_sendMessageFrame->setObjectName(QStringLiteral("m_sendMessageFrame"));
        ...
        m_depositsFrame->setObjectName(QStringLiteral("m_depositsFrame"));
        ...
        menubar->setGeometry(QRect(0, 0, 1014, 20));
        ...
        menuAdditional->setObjectName(QStringLiteral("menuAdditional"));
        ...
        menuAdditional->addAction(m_exchange);
        menuAdditional->addSeparator();
        menuAdditional->addAction(m_Block_Explorer);
        ...
        QObject::connect(m_exchange, SIGNAL(triggered()), MainWindow, SLOT(aboutQt()));
        QObject::connect(m_Block_Explorer, SIGNAL(triggered()), MainWindow, SLOT(aboutQt()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        m_importKeyAction->setText(QApplication::translate("MainWindow", "Import private key", 0));
...
#ifndef QT_NO_TOOLTIP
        m_resetAction->setToolTip(QApplication::translate("MainWindow", "Reset wallet", 0));
#endif // QT_NO_TOOLTIP
        m_exchange->setText(QApplication::translate("MainWindow", "Exchange", 0));
        m_Block_Explorer->setText(QApplication::translate("MainWindow", "Block Explorer", 0));
        menuFile->setTitle(QApplication::translate("MainWindow", "File", 0));
        menuSettings->setTitle(QApplication::translate("MainWindow", "Settings", 0));
        menuHelp->setTitle(QApplication::translate("MainWindow", "Help", 0));
        menuAdditional->setTitle(QApplication::translate("MainWindow", "Additional", 0));
