...
public:
    ...
    {
        MessageDetailsDialog->setWindowTitle(QApplication::translate("MessageDetailsDialog", "Message", 0));
        label->setText(QApplication::translate("MessageDetailsDialog", "Block height", 0));
        m_heightLabel->setText(QString());
        label_5->setText(QApplication::translate("MessageDetailsDialog", "Amount", 0));
        m_hashLabel->setText(QString());
        m_amountLabel->setText(QString());
        label_3->setText(QApplication::translate("MessageDetailsDialog", "Transaction hash", 0));
        label_7->setText(QApplication::translate("MessageDetailsDialog", "Message size (bytes)", 0));
        m_sizeLabel->setText(QString());
        m_replyButton->setText(QApplication::translate("MessageDetailsDialog", "Reply", 0));
        m_saveButton->setText(QApplication::translate("MessageDetailsDialog", "Save to file", 0));
        m_prevButton->setText(QApplication::translate("MessageDetailsDialog", "<<", 0));
        m_nextButton->setText(QApplication::translate("MessageDetailsDialog", ">>", 0));
        m_okButton->setText(QApplication::translate("MessageDetailsDialog", "Ok", 0));
    } // retranslateUi
