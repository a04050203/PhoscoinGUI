...
public:
    ...
    {
        NewPoolDialog->setWindowTitle(QApplication::translate("NewPoolDialog", "New pool", 0));
        label->setText(QApplication::translate("NewPoolDialog", "Host:", 0));
        label_2->setText(QApplication::translate("NewPoolDialog", "Port:", 0));
        m_cancelButton->setText(QApplication::translate("NewPoolDialog", "Cancel", 0));
        m_okButton->setText(QApplication::translate("NewPoolDialog", "OK", 0));
    } // retranslateUi
