...
public:
    ...
    void setupUi(QFrame *TransferFrame)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/paste"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_transactionCommentEdit->setObjectName(QStringLiteral("m_transactionCommentEdit"));
        ...
        QObject::connect(m_transactionCommentEdit, SIGNAL(textChanged(QString)), TransferFrame, SLOT(commentEdited(QString)));
    ...
    void retranslateUi(QFrame *TransferFrame)
    {
        ...
        label_4->setText(QApplication::translate("TransferFrame", "Crypto comment:", 0));
    } // retranslateUi
